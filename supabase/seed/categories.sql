...
('טיפוח עצמי', 'Self Love', 'expense', 'Nails, haircuts, dental hygienist, facials', ARRAY['מספרה', 'ציפורניים', 'שיננית', 'ספא', 'טיפוח']),
...
('טיפולים אישיים', 'Personal Treatment', 'expense', 'Galia, Daniel, Efrat, Yoav, Arava', ARRAY['גליה', 'דניאל', 'אפרת', 'יואב', 'ערבה', 'טיפול']),
