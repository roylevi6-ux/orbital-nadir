...
async function seedCategories() {
    ...
    const categories = [
        ...
        { name_hebrew: 'הוצאות בלתי צפויות', name_english: 'Unexpected Expenses', type: 'expense', description: 'Unexpected one-time expenses', keywords: ['בלתי צפוי', 'חד פעמי'] },
        { name_hebrew: 'ימי הולדת ומתנות', name_english: 'Birthdays & Gifts', type: 'expense', description: 'Birthday parties and gift purchases', keywords: ['מתנה', 'מתנות', 'יום הולדת', 'מסיבה'] },
        { name_hebrew: 'חיים פעילים', name_english: 'Active Life', type: 'expense', description: 'Sport and wellness activities for parents', keywords: ['ספורט', 'כושר', 'אימון', 'שחייה', 'ריצה'] },
        { name_hebrew: 'דייטים', name_english: 'Dating', type: 'expense', description: 'Date nights and romantic outings', keywords: ['דייט', 'רומנטי', 'ערב זוגי'] },
