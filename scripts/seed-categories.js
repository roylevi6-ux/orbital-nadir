...
async function seedCategories() {
    ...
    const categories = [
        ...
        { name_hebrew: 'טיפוח עצמי', name_english: 'Self Love', type: 'expense', description: 'Nails, haircuts, dental hygienist, facials', keywords: ['מספרה', 'ציפורניים', 'שיננית', 'ספא', 'טיפוח'] },
        ...
        { name_hebrew: 'טיפולים אישיים', name_english: 'Personal Treatment', type: 'expense', description: 'Galia, Daniel, Efrat, Yoav, Arava', keywords: ['גליה', 'דניאל', 'אפרת', 'יואב', 'ערבה', 'טיפול'] },
